...
class Attention2(nn.Module):
    ...
    def forward(self, x):
        ...
        q, k, v = qkv.unbind(
            0
        )  # make torchscript happy (cannot use tensor as tuple) (h c fph)
...
class DiTblock(nn.Module):
    ...
    def __init__(self, feature_dim=2000, mlp_ratio=4.0, num_heads=10, **kwargs) -> None:
        ...
        self.attn = Attention2(
            feature_dim, num_heads=num_heads, qkv_bias=True, **kwargs
        )
...
class DiT_stDiff(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.in_layer = nn.Sequential(nn.Linear(input_size, hidden_size))
        ...
        self.blks = nn.ModuleList(
            [
                BaseBlock[dit_type](
                    self.hidden_size, mlp_ratio=self.mlp_ratio, num_heads=self.num_heads
                )
        ...
        # out layer
        self.out_layer = FinalLayer(self.hidden_size, self.output_size)
